...
SDKVERSION="9.2" #指明ios sdk的版本号，目前最新的是7.1，不清楚的同学可以 ls /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS7.1.sdk/ 一下看看自己的iPhoneOS7.1.sdk是不是7.1
CURRENTPATH=`pwd`
...
cp -R ${BUILDPATH}/openssl-iPhoneOS${SDKVERSION}-armv7.sdk/include/openssl ${INCLUDEPATH}/
echo "Building done."
echo "Cleaning up..."
#rm -rf ${SRCPATH}/openssl-${VERSION}
echo "Done."
